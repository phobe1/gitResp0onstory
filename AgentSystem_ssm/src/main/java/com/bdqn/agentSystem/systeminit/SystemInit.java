package com.bdqn.agentSystem.systeminit;
...
public class SystemInit implements ServletContextListener{
	...
	public void contextInitialized(ServletContextEvent arg0) {
		...
		WebApplicationContext cxt = WebApplicationContextUtils.getWebApplicationContext(arg0.getServletContext());
		if( null == cxt )
		...
		if(null != cxt){
			...
			SystemConfigService systemConfigService = (SystemConfigService)cxt.getBean("systemConfigService");
